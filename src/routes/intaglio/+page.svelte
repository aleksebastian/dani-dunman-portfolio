...
{#if heroLoaded}
	<div class="grid">
		...
		<p class="full-text-wide py-lg">
			...
			different each can be. The images used are prints done by Elvia Perrin. The secondary images
			are zoomed-in, smaller sections of the print's patterns, textures, or parts that summarize
			each piece. I also used images of supplies found around the studio and process work from
