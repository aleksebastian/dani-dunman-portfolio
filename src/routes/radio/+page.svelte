...
{#if heroLoaded}
	<div class="grid">
		...
		<div class="full-text py-md">
			...
			<p class="py-sm">
				Before researching anything related to radio, I focused on what kind of experience I wanted
				to create for the audience. There were a couple of things I wanted to make sure were true
				for my exhibit, so I made a list that I could reference to ensure that I stayed focused on
				the challenge. I call it the “needs to be true” list.
			</p>
		</div>
		...
		<div class="bestPractices content pt-md">
			...
			<p>
				The first thing I searched for were best practices for museums. And what I found was pretty
				straight forward:
			</p>
			<ul>
				<li>
					...
					<p>Have a persona (audience) in mind</p>
				</li>
				<li>
					<div class="icon">
						<MdArrowForward />
					</div>
					<p>A good exhibit will tell a story (and stories within that story)</p>
				</li>
				<li>
					<div class="icon">
						<MdArrowForward />
					</div>
					<p>Have a defined linear flow</p>
				</li>
				<li>
					<div class="icon">
						<MdArrowForward />
					</div>
					<p>Gamification can make an exhibit exciting</p>
				</li>
				<li>
					<div class="icon">
						<MdArrowForward />
					</div>
					<p>Divide large exhibits into sections</p>
				</li>
			</ul>
	...
	<div class="full grid bg-grey">
		<div class="full-text py-md">
			...
			<p>
				...
				reading as the main form of contextualizing and education, and guides the visitor through a
				definite timeline and path, I can enhance the visitor experience at the Museum of
				Communication while also appealing to a wider audience. This will ultimately bring in more
				people and give them a more interesting and memorable experience.
			</p>
		</div>
	</div>
	<div class="grid py-md">
		<div class="full-text bestPractices">
			<p class="label">Solution</p>
			<p>
				Through this exhibit, the visitor will experience firsthand what it was like to be in 5
				different times in history when radio changed the world. Each room presents, in story form,
				one of these eras. And in each, the visitor plays an assisting role in the achievement of
				the event. The last room of the walk-through will recap everything the viewer learned and
				present them with a takeaway. The visitor will go home having learned about how the radio
				was discovered and invented, how it works, and how it has changed and influenced history.
			</p>
			<p>The five stories that the visitor will travel through, in order, are:</p>
			<ol>
		...
		<div class="content py-md museumImgs">
			<img
				src="https://res.cloudinary.com/blitva/image/upload/v1645400424/Dani/radio/floorplan1_obr2q4.jpg"
				alt="Museum of Communication Radio Exhibit"
			/>
			<img
				src="https://res.cloudinary.com/blitva/image/upload/v1645400423/Dani/radio/floorplan2_elniuo.jpg"
		...
		<div class="full-text py-md">
			<p class="label pb-sm">Takeaways/What I learned:</p>
			<p class="text-md">
				Look for inspiration in places unrelated to the project you’re working on.
			</p>
			<p>
				When I researched museum exhibits, I wanted to see what other museums had done about radio.
				In a nutshell, I couldn’t find any exhibit styles besides the traditional “look but don’t
				touch.” No one had done anything interesting with the radio. This was a good thing because
				whatever I decided to do would be new. But I also had no jumping-off point or inspiration on
				how to present radio. This led me to search for inspiration outside of museums. One of the
				most interesting things I found was escape rooms, and I believe this helped jumpstart a more
				exciting direction for this exhibit.
			</p>
		</div>
			...
			<div class="furtherDev">
				<div class="bestPractices">
					...
					<p>
						...
						do is make the transition from room to room smoother. I’d create specific personas for
						visitors.
					</p>
				</div>
				<div class="bestPractices">
